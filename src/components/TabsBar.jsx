...
import { ChevronLeftIcon, ChevronRightIcon, CloseIcon, CopyIcon, LayoutGridIcon, LibraryIcon, PinIcon, PlusIcon, ScrollIcon } from './Icons.jsx';
...
function TabsBar({ tabs, activeTabId, onSelectTab, onCloseTab, onNewTab, onContextMenu, onReorderTabs, onPinTab, onDuplicateTab }) {
